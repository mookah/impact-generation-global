...
const slides = [
  "/images/school-ministry/school-ministry-hero.jpg",
  "/images/school-ministry/school-ministry-2.jpg",
  "/images/school-ministry/school-ministry-3.jpg",
  "/images/school-ministry/school-ministry-4.jpg",
  "/images/school-ministry/school-ministry-5.jpg",
  "/images/school-ministry/school-ministry-6.jpg",
  "/images/school-ministry/school-ministry-7.jpg",
  "/images/school-ministry/school-ministry-8.jpg",
  "/images/school-ministry/school-ministry-9.jpg",
];

const stats = [
  { value: "Schools", label: "Reached through outreach" },
  { value: "Students", label: "Encouraged and mentored" },
  { value: "Faith", label: "Guiding every message" },
  { value: "Purpose", label: "Helping youth choose wisely" },
];
...
const focusAreas = [
  {
    icon: "📖",
    title: "Faith & Purpose",
    desc: "Helping students discover identity, purpose, and hope through Christ-centered teaching.",
  },
  {
    icon: "🧠",
    title: "Wise Choices",
    desc: "Encouraging healthy decisions, discipline, resilience, and personal responsibility.",
  },
  {
    icon: "🤝",
    title: "Mentorship",
    desc: "Creating opportunities for students to learn from leaders, mentors, and positive role models.",
  },
  {
    icon: "🎓",
    title: "School Outreach",
    desc: "Partnering with schools to encourage students through classroom and assembly sessions.",
  },
  {
    icon: "❤️",
    title: "Character Building",
    desc: "Equipping young people with confidence, integrity, respect, and leadership values.",
  },
  {
    icon: "🌍",
    title: "Community Impact",
    desc: "Strengthening families, schools, and communities by investing in the next generation.",
  },
];
      ...
      <section className="relative isolate min-h-screen overflow-hidden pt-32 text-white md:pt-36">
        {slides.map((src, index) => (
          <Image
            key={src}
            src={src}
            alt={`School Ministry slide ${index + 1}`}
            fill
            priority={index === 0}
            sizes="100vw"
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(245,158,11,0.26),transparent_35%)]" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[calc(100vh-128px)] max-w-7xl items-center px-6 pb-20">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-7 max-w-4xl text-4xl font-black leading-tight tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              Guiding students toward faith, purpose, and wise life choices.
            </h1>

            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-200 sm:text-lg md:text-xl">
              Impact Generation Global reaches students through teaching,
              mentorship, school outreach, discipleship, and conversations that
              help young people build strong foundations for life.
            </p>
        ...
        <button
          type="button"
          onClick={prevSlide}
          aria-label="Previous school ministry photo"
        ...
        <button
          type="button"
          onClick={nextSlide}
          aria-label="Next school ministry photo"
          ...
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight tracking-tight sm:text-4xl lg:text-5xl">
                Reaching students where they are and helping them build a
                stronger future.
              </h2>

              <p className="mt-6 text-base leading-8 text-slate-600 sm:text-lg">
                Through School Ministry, Impact Generation Global partners with
                schools to encourage students in faith, identity, leadership,
                discipline, education, and healthy choices.
              </p>

              <p className="mt-4 text-base leading-8 text-slate-600 sm:text-lg">
                Our desire is to see young people grow with courage, wisdom,
                dignity, and purpose as they prepare for life, leadership, and
                service.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative h-[340px] overflow-hidden rounded-[2rem] shadow-2xl sm:h-[480px]">
                <Image
                  src="/images/school-ministry/school-ministry-2.jpg"
                  alt="School ministry classroom session"
                  fill
        ...
        <section className="bg-white px-6 py-20">
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight tracking-tight sm:text-4xl lg:text-5xl">
                Teaching, mentoring, and encouraging students.
              </h2>

              <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
                Our school outreach combines practical teaching, faith-based
                encouragement, mentorship, and community care.
              </p>
            </div>
        ...
        <section className="px-6 py-20">
          <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2rem] bg-slate-950 shadow-2xl lg:grid-cols-2">
            <div className="relative min-h-[360px]">
              <Image
                src="/images/school-ministry/school-ministry-3.jpg"
                alt="Students gathered for outdoor school ministry"
                fill
                sizes="(max-width: 1024px) 100vw, 50vw"
                className="object-cover"
              />
            ...
            <div className="p-8 text-white sm:p-12 lg:p-14">
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight sm:text-4xl">
                Every school visit is a chance to speak hope.
              </h2>

              <p className="mt-6 text-base leading-8 text-slate-300 sm:text-lg">
                Students are facing real questions about identity, relationships,
                pressure, discipline, faith, and the future. School Ministry
                gives us an opportunity to walk into their world with guidance,
                encouragement, and truth.
              </p>

              <p className="mt-4 text-base leading-8 text-slate-300 sm:text-lg">
                Through classroom sessions, outdoor gatherings, and personal
                conversations, we help students understand that their choices
                matter and their lives carry purpose.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight sm:text-4xl lg:text-5xl">
                See School Ministry in action.
              </h2>

              <p className="mt-6 text-base leading-8 text-slate-300 sm:text-lg">
                Watch how Impact Generation Global is encouraging students,
                strengthening schools, and helping young people discover faith,
                dignity, and purpose.
              </p>

              <div className="mt-8">
                <a
                  href="https://youtu.be/aIpldwPleGs"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-5 shadow-2xl backdrop-blur sm:p-8">
              <div className="overflow-hidden rounded-3xl shadow-2xl">
                <div className="aspect-video">
                  <iframe
                    ...
                    src="https://www.youtube.com/embed/aIpldwPleGs"
                    title="School Ministry Video"
              ...
              <h3 className="mt-7 text-2xl font-black">
                School Ministry Video
              </h3>

              <p className="mt-3 leading-7 text-slate-300">
                A visual look at teaching, mentorship, outreach, and student
                encouragement through Impact Generation Global.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white px-6 py-20">
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 text-center">
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight sm:text-4xl lg:text-5xl">
                School outreach in pictures.
              </h2>

              <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                Use the slider to view moments from classroom teaching, outdoor
                student gatherings, and ministry outreach.
              </p>
            </div>
              ...
              <div className="relative h-[300px] overflow-hidden rounded-[1.5rem] sm:h-[460px] lg:h-[560px]">
                {slides.map((src, index) => (
                  <Image
                    key={src}
                    src={src}
                    alt={`School ministry gallery slide ${index + 1}`}
                    fill
                    sizes="100vw"
        ...
        <section className="px-6 py-20">
          <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-gradient-to-br from-emerald-700 via-emerald-800 to-slate-950 p-8 text-center text-white shadow-2xl sm:p-12">
            ...
            <h2 className="mx-auto mt-4 max-w-3xl text-3xl font-black leading-tight sm:text-4xl lg:text-5xl">
              Help us keep reaching students with faith, hope, and purpose.
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-emerald-50 sm:text-lg">
              Your support helps provide school outreach, mentorship, teaching
              materials, student engagement, and discipleship opportunities in
              Zambia.
            </p>
